...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Oct 07 13:02:07 MDT 2021
  */
        ...
        RESULT = f1+"*"+f2;
         if (f1 instanceof Integer){
            if(f2 instanceof String){
                 System.out.println("*****No se pueden multiplicar int * str");
            }
            if (f2 instanceof Double){
                 System.out.println("*****Sí se pueden multiplicar int * decimal");

            }
            if (f2 instanceof Integer){
                 System.out.println("*****Sí se pueden multiplicar int * int");
            }
        }
        System.out.println("factor1 "+f1);
        System.out.println("factor2 "+f2);
