...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Oct 07 19:02:57 MDT 2021
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Sintax$act_num)
		...
		Object f2 = (Object)((java_cup.runtime.Symbol) CUP$Sintax$stack.peek()).value;
                ...
                if(f2.toString().equals("false") || f1.toString().equals("true") )
                    System.out.println("ES booleana");
    ...
    System.out.println("EMPIEZA TERMINO");
        ...
        if (f1 instanceof Integer){
            if(f2 instanceof String){
                ...
                lb.setFont(new Font("Verdana", Font.PLAIN, 14));
                lb.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
                lb.setText("Error en la línea " + (f2right+1) + ". Error sintáctico. No se puede dividir una variable 'just' una 'word'" );   
                VentanaPrincipal.labelsErrores.add(new LabelError(lb, "Error sintáctico. No se puede dividir una variable 'just' una 'word'", f2right+1,SINTACTICO,
                new Gramatica("termino ::= factor: SIGNO_DE_MULTIPLICACIÓN factor", "No se puede dividir una variable 'just' una 'word'")));
            }
        }
        if (f1 instanceof String){
            if(f2 instanceof Integer){
                ...
                lb.setFont(new Font("Verdana", Font.PLAIN, 14));
                lb.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
                lb.setText("Error en la línea " + (f2right+1) + ". Error sintáctico. No se puede dividir una variable 'word' una 'just'" );   
                VentanaPrincipal.labelsErrores.add(new LabelError(lb, "Error sintáctico. No se puede dividir una variable 'word' una 'just'", f2right+1,SINTACTICO,
                new Gramatica("termino ::= factor: SIGNO_DE_MULTIPLICACIÓN factor", "No se puede dividir una variable 'word' una 'just'")));
            }
        }
        ...
        if (f1 instanceof Integer){
            if(f2 instanceof String){
                ...
                lb.setFont(new Font("Verdana", Font.PLAIN, 14));
                lb.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
                lb.setText("Error en la línea " + (f2right+1) + ". Error sintáctico. No se puede multiplicar una variable 'just' una 'word'" );   
                VentanaPrincipal.labelsErrores.add(new LabelError(lb, "Error sintáctico. No se puede multiplicar una variable 'just' una 'word'", f2right+1,SINTACTICO,
                new Gramatica("termino ::= factor: SIGNO_DE_MULTIPLICACIÓN factor", "No se puede multiplicar una variable 'just' una 'word'")));
            }
        }
        if (f1 instanceof String){
            if(f2 instanceof Integer){
